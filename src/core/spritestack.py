...
class SpriteStack:
    ...
    def __init__(self, image_path=None, num_layers=8, layer_offset=1, default_width=32, default_height=32, outline_enabled=False, outline_color=(0, 0, 0), outline_thickness=1, outline_offset=1):
