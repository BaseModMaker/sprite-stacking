...
BASE_PATH = abspath(dirname(dirname(__file__)))  # Go up one level to project root
ASSET_PATH = join(BASE_PATH, "assets")  # Assets directory
FONT_PATH = join(ASSET_PATH, "fonts")
IMAGE_PATH = join(ASSET_PATH, "images")
SOUND_PATH = join(ASSET_PATH, "sounds")
SOUND_FORMAT = "ogg"
